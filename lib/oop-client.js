    ...
    getEpisodeData(serviceId, episode, category).then((result) => {
      ...
      .then((costData) => {
        ...
        costData.allowedAmt.forEach((facility) => {
          const narrative2 = `After subtracting $${facility.oop}, your assumed remaining deductible is $${Math.max(0, costData.dedIndRem - facility.oop)} and assumed remaining out of pocket maximum is $${Math.max(0, costData.oopIndRem - facility.oop)}.`;
      ...
      .then((costData) => {
        ...
        if (costTable[1] === undefined) {
          ...
          narrative1 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[0].oop}.`;
          totalAverage = +costTable[0].allowedAmt[1].oop + +costTable[1].allowedAmt[1].oop;
          narrative2 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[1].oop}.`;
          totalHigh = +costTable[0].allowedAmt[2].oop + +costTable[1].allowedAmt[2].oop;
          narrative3 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[2].oop}.`;
        } else {
          totalLow = +costTable[0].allowedAmt[0].oop + +costTable[1].allowedAmt[0].oop + +costTable[2].allowedAmt[0].oop;
          narrative1 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[0].oop} + $${costTable[2].allowedAmt[0].oop}.`;
          totalAverage = +costTable[0].allowedAmt[1].oop + +costTable[1].allowedAmt[1].oop + +costTable[2].allowedAmt[1].oop;
          narrative2 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[1].oop} + $${costTable[2].allowedAmt[1].oop}.`;
          totalHigh = +costTable[0].allowedAmt[2].oop + +costTable[1].allowedAmt[2].oop + +costTable[2].allowedAmt[2].oop;
          narrative3 = `Your total out of pocket cost estimate: $${costTable[0].allowedAmt[0].oop} + $${costTable[1].allowedAmt[2].oop} + $${costTable[2].allowedAmt[2].oop}.`;
        }
